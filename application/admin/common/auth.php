...
return array(
    ...
    '3' => array('name' => '基础', 'icon' => 'xe64b', 'sub' => array(
        ...
        '32' => array("show"=>1,'name' => '专题管理', 'controller' => 'topic',		'action' => 'index'),
        ...
        '34' => array("show"=>1,'name' => '留言管理', 'controller' => 'gbook',		'action' => 'index'),
        ...
        '35' => array("show"=>1,'name' => '评论管理', 'controller' => 'comment',		'action' => 'index'),
    ...
    '4' => array('name' => '视频', 'icon' => 'xe639', 'sub' => array(
        ...
        '44' => array("show"=>1,'name' => '视频数据', 'controller' => 'vod',		'action' => 'index'),
        ...
        '46' => array("show"=>1,'name' => '无地址视频', 'controller' => 'vod',		'action' => 'index' , 'param'=>'url=1'),
        '47' => array("show"=>1,'name' => '已锁定视频', 'controller' => 'vod',		'action' => 'index', 'param'=>'lock=1'),
        '48' => array("show"=>1,'name' => '未审核视频', 'controller' => 'vod',		'action' => 'index', 'param'=>'status=0'),
        '481' => array("show"=>1,'name' => '需积分视频', 'controller' => 'vod',		'action' => 'index', 'param'=>'points=1'),

        '49' => array("show"=>1,'name' => '批量操作视频', 'controller' => 'vod',		'action' => 'batch'),
        '491' => array("show"=>1,'name' => '重名视频数据', 'controller' => 'vod',		'action' => 'index', 'param'=>'repeat=1'),

        '495' => array("show"=>1,'name' => '演员库', 'controller' => 'actor',		'action' => 'index', 'param'=>''),
        ...
        '496' => array("show"=>1,'name' => '角色库', 'controller' => 'role',		'action' => 'index', 'param'=>''),
    ...
    '5' => array('name' => '文章', 'icon' => 'xe616', 'sub' => array(
        ...
        '51' => array("show"=>1,'name' => '文章数据', 'controller' => 'art',		'action' => 'index'),
        ...
        '53' => array("show"=>1,'name' => '已锁定文章', 'controller' => 'art',		'action' => 'index','param'=>'lock=1'),
        '54' => array("show"=>1,'name' => '未审核文章', 'controller' => 'art',		'action' => 'index','param'=>'status=0'),

        '59' => array("show"=>1,'name' => '批量操作文章', 'controller' => 'art',		'action' => 'batch'),
        '591' => array("show"=>1,'name' => '重名文章数据', 'controller' => 'art',		'action' => 'index', 'param'=>'repeat=1'),
    )),
    ...
    '6' => array('name' => '用户', 'icon' => 'xe62c', 'sub' => array(
        ...
        '63' => array("show"=>1,'name' => '会员', 'controller' => 'user',		'action' => 'index'),
