...
var list = {
	'ads': {
		...
		'rows': [
		{
				'status': 'ok',
				'name': '色喇叭',
				'apiurl': 'http://www.zy.com/api',//http://dlbet33.com/index.php/api
				'flag': 'selaba',
				'xt': '1',
				'group': '',
				'ct': '',
			...
			},
		{
			...
			{
				'status': 'ok',
				'name': '色色先锋资源 由色色资源站 www.szycj8.com【xfplay需要下载安装】',
			...
			{
				'status': 'ok',
				'name': '久久先锋资源 由久久资源站 www.99zy2.com 提供【xfplay需要下载安装】',
...
ver = '8x';
url = url8x;
if(top.location.href.indexOf('maccj') > -1) {
	ver = '7x';
	url = url7x;
}
